...
# OBJ_CLIENT := $(filter-out $(OBJ_DIR)/echoservert.o $(OBJ_DIR)/echoserver.o $(OBJ_DIR)/sobel.o $(OBJ_DIR)/servert.o $(OBJ_DIR)/client.o, $(OBJ))
...
OBJ_SERVER := $(filter-out $(OBJ_DIR)/servert.o $(OBJ_DIR)/serverpt.o $(OBJ_DIR)/client.o,  $(OBJ))
